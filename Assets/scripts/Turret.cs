...
public class Turret : MonoBehaviour
{
    ...
    void UpdateTarget()
    {
        ...
        {
            float distantanceToEnemy = Vector3.Distance(transform.position, enemy.transform.position);
            if(distantanceToEnemy <= shortestDistance )
            {
                shortestDistance = distantanceToEnemy;
                nearestEnemy = enemy;
                //Debug.Log("enemy pos" + nearestEnemy.transform.position);
            }
        }
